...
Sea una variable geométrica $X \sim geom(p=0.05)$
...
Suponga que $X$ tiene una distribución hipergeométrica con $N=100$, $n=4$ y $K=20$.
...
Sea la variable $X$ con distribución binomial negativa con $N=10$, $n=5$. ($X \sim nbinom(x,n,p,mu)$)

(a) ¿Cuál es la probabilidad de que ninguno de las llantas tenga imperfecciones?

(b) ¿Cuál es la probabilidad de que sólo una de las llantas tenga imperfecciones?

(c) ¿Cuál es la probabilidad de que una o más llantas tenga imperfecciones?
...
10\. La vida útil de una bombilla de vehículo sigue una distribución lognormal con media $\mu = 1.2$ y varianza $\sigma^2=0.4$:
