...
<div class="box1 with-label">
<div class="label">Problema 4.1</div> 
...
(e) Construya la gráfica de $f_X(x)$
</div>

<br/><br/>

<div class="box1 with-label">
<div class="label">Problema 4.2</div> 
...
<div class="box1 with-label">
<div class="label">Problema 4.3</div> 
...
<div class="box1 with-label">
<div class="label">Problema 4.4</div> 
...
<div class="box1 with-label">
<div class="label">Problema 4.5</div> 
...
<div class="box1 with-label">
<div class="label">Problema 4.6</div> 
...
<div class="box1 with-label">
<div class="label">Problema 4.7</div> 
...
<div class="box1 with-label">
<div class="label">Problema 4.8</div> 
...
<div class="box1 with-label">
<div class="label">Problema 4.9</div> 
...
<div class="box1 with-label">
<div class="label">Problema 4.10</div> 
...
<div class="box1 with-label">
<div class="label">Problema 4.11</div> 
...
<div class="box1 with-label">
<div class="label">Problema 4.12</div> 
...
<div class="box1 with-label">
<div class="label">Problema 4.13</div> 
...
<div class="box1 with-label"> 
<div class="label">Problema 4.14</div>
...
<div class="box1 with-label">
<div class="label">Problema 4.15</div> 
...
<div class="box1 with-label">
<div class="label">Problema 4.16</div> 
...
<div class="box1 with-label">
<div class="label">Problema 4.17</div> 
...
<div class="box1 with-label">
<div class="label">Problema 4.18</div> 
...
<div class="box1 with-label">
<div class="label">Problema 4.19</div> 
...
<div class="box1 with-label">
<div class="label">Problema 4.20</div> 
...
<div class="box1 with-label">
<div class="label">Problema 4.21</div> 
...
<div class="box1 with-label">
<div class="label">Problema 4.22</div> 
...
<div class="box1 with-label">
<div class="label">Problema 4.23</div> 
...
<div class="box1 with-label">
<div class="label">Problema 4.24</div> 
...
<div class="box1 with-label">
<div class="label">Problema 4.25</div> 
...
<div class="box1 with-label">
<div class="label">Problema 4.26</div> 
...
(c) Calcule la probabilidad de que lleguen dos clientes dentro de un intervalo de dos horas continuas, por ejemplo entre 10 AM y 12 M.

(d) Calcule el valor esperado del número de personas que llegan a la tienda entre las 2:30 y las 4:30 PM.
...
<div class="box1 with-label">
<div class="label">Problema 4.27</div> 
...
<div class="box1 with-label">
<div class="label">Problema 4.28</div> 
...
(a) Si para aprobar el examen Juan debe responder mínimo 60 preguntas correctamente, calcule la probabilidad de que María apruebe el examen.

(b) Calcule la probabilidad de que María deba responder 10 preguntas hasta responder la primera pregunta correctamente.

(c) ¿Cuál es el número esperado de preguntas que María responderá erróneamente hasta responder 5 preguntas correctamente?
...
<div class="box1 with-label">
<div class="label">Problema 4.29</div> 
...
(a) La probabilidad de que la muestra no contenga microorganismos contaminantes.

(b) La probabilidad de que una muestra contenga más de cinco microorganismos contaminantes.
...
<div class="box1 with-label">
<div class="label">Problema 4.30</div> 
...
<div class="box1 with-label">
<div class="label">Problema 4.31</div> 

Para una variable aleatoria $X \sim \text{unif}(x,a,b)$ con $a = 10$ y $b = 20$ determine:

(a) Construya un bosquejo de la gráfica de la función de densidad de probabilidad $f_X(x)$.

(b) $P(X \leq 12)$, $P(13 \leq X \leq 15)$, $P(X \geq 18)$.
...
<div class="box1 with-label">
<div class="label">Problema 4.32</div> 
...
<div class="box1 with-label">
<div class="label">Problema 4.33</div> 
...
<div class="box1 with-label">
<div class="label">Problema 4.34</div> 
...
(b) $P(X \leq 100)$, $P(300 \leq X \leq 400)$, $P(X \geq 550)$.

(c) Determine el valor de $k$ que cumpla: $P(-k < X < k) = 0.90$.

(d) Determine el valor de $k$ que cumpla: $P(-k < X < k) = 0.95$.
...
<div class="box1 with-label">
<div class="label">Problema 4.35</div> 
...
(d) Realice un bosquejo de la gráfica de $f_X(x)$.
...
<div class="box1 with-label">
<div class="label">Problema 4.36</div> 
...
(d) Si Doris y Mauricio acuerdan además, que cada uno esperará al otro un máximo de 10 minutos, ¿cuál es la probabilidad de que se encuentren?
...
<div class="box1 with-label">
<div class="label">Problema 4.37</div> 
...
(b) ¿Cuál es el percentil 25 de las puntuaciones?
...
<div class="box1 with-label">
<div class="label">Problema 4.38</div> 
...
(a) ¿Qué proporción de personas tienen estatura entre 60 y 66 pulgadas?

(b) La estatura de Juan es 0.5 desviación estándar mayor a la media. ¿Qué proporción es más alta que Juan?

(c) ¿Cuánto mide una persona cuya estatura se encuentra en el 90 percentil?

(d) Si elige aleatoriamente una persona, ¿cuál es la probabilidad de que mida más de 67 pulgadas?

(e) Si se elige aleatoriamente a cinco personas, ¿cuál es la probabilidad de que sólo una mida más de 67 pulgadas?
...
<div class="box1 with-label">
<div class="label">Problema 4.39</div> 
...
(a) ¿Cuál es la probabilidad de que una muestra tenga resistencia mayor a 12 GPa?

(b) Determine el primer cuartil de la resistencia.

(c) Determine el percentil 95 de la resistencia.
...
<div class="box1 with-label">
<div class="label">Problema 4.41</div> 

Un indicador importante de salud es el IMC:

Sea: $\mu = 3.215$ y $\sigma = 0.157$ (hombres).

(a) Si se elige un hombre, ¿cuál es la probabilidad que su riesgo sea Obesidad 1 (30 a 34.9)?

(b) Dieta Bienestar quiere conocer proporciones. ¿Cuál proporción esperaría en cada rango de riesgo?
...
<div class="box1 with-label">
<div class="label">Problema 4.42</div> 
...
<div class="box1 with-label">
<div class="label">Problema 4.43</div> 
...
<div class="box1 with-label">
<div class="label">Problema 4.44</div> 
...
<div class="box1 with-label">
<div class="label">Problema 4.45</div> 
...
<div class="box1 with-label">
<div class="label">Problema 4.46</div> 
...
<div class="box1 with-label">
<div class="label">Problema 4.47</div> 
...
<div class="box1 with-label">
<div class="label">Problema 4.48</div> 
...
<div class="box1 with-label">
<div class="label">Problema 4.49</div> 
...
<div class="box1 with-label">
<div class="label">Problema 4.50</div> 
...
<div class="box1 with-label">
<div class="label">Problema 4.51</div> 
...
<div class="box1 with-label">
<div class="label">Problema 4.52</div> 
...
<div class="box1 with-label">
<div class="label">Problema 4.53</div> 
...
(d) El valor de $X$ tal que el 95% de los cables tienen resistencia menor o igual a este valor.
...
(d) El porcentaje de ejes que cumplen con una tolerancia de $\pm 0.02$ mm.
...
<div class="box1 with-label">
<div class="label">Problema 4.54</div> 
...
(d) La vida útil que supera el 90% de los motores.
...
<div class="box1 with-label">
<div class="label">Problema 4.55</div> 
...
(d) El límite superior tal que el 98% de los tanques no lo sobrepasen.
...
<div class="box1 with-label">
<div class="label">Problema 4.56</div> 
...
(d) El porcentaje de barras dentro del rango 1.98 m a 2.02 m.
...
<div class="box1 with-label">
<div class="label">Problema 4.57</div> 
...
(d) La probabilidad de que un componente pese entre 148 y 152 gramos.
...
<div class="box1 with-label">
<div class="label">Problema 4.58</div> 
...
(d) El tiempo máximo que no se supera en el 85% de las unidades.
...
<div class="box1 with-label">
<div class="label">Problema 4.59</div> 
...
(d) La temperatura mínima superada por el 10% de las mediciones.
...
<div class="box1 with-label">
<div class="label">Problema 4.60</div> 
...
(d) El límite superior tal que el 95% de las concentraciones están por debajo de este valor.
...
<div class="box1 with-label">
<div class="label">Problema 4.61</div> 
...
(d) La capacidad mínima garantizada superada por el 99% de los elevadores.
