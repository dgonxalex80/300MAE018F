...
Para analizar este problema, Andrés recolectó una muestra de 50 paquetes de café del proceso de empaque. Con base en información histórica, sabe que el peso del café sigue una distribución normal con media (μ) desconocida y desviación estándar (σ) conocida de 5 gramos.

De la muestra tomada, Andrés obtuvo una media muestral de 498 gramos. Él desea saber si, con esta muestra, existe evidencia suficiente para afirmar que la máquina está en promedio empacando menos de los 500 gramos prometidos, utilizando un nivel de significancia del 5%.
...
Para verificar esto, Laura recoge una muestra de 40 reportes recientes atendidos por su equipo y calcula que el tiempo promedio fue de 64 minutos, con una desviación estándar poblacional conocida de 10 minutos. Ella sabe que los tiempos de atención se distribuyen normalmente. Ahora, con un nivel de significancia del 5%, quiere evaluar si estos datos proporcionan evidencia suficiente para afirmar que efectivamente el tiempo promedio para solucionar los reportes supera los 60 minutos establecidos como estándar.
